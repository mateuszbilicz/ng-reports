...
import {CONFIG_FIELD_DESCRIPTIONS, DEFAULT_SYSTEM_CONFIG, SystemConfig} from './system-config';
import {InjectModel} from '@nestjs/mongoose';
import {Model} from 'mongoose';
import {ConfigField, SystemConfigView} from '../../database/schemas/system-config.schema';
...
export class SystemConfigurationService {
    ...
    getConfigRaw() {
        return this.config.getValue() as SystemConfigView;
    }
}
